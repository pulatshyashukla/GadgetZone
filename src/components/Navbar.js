    ...
    >
      ...
      <Modal.Body>
        <Form>
          ...
          <button
            class="w-100 mb-2 btn btn-md rounded-3 btn-primary"
            type="submit"
          >
            Sign up
          </button>
          ...
          <button
            className="w-100 py-1 mb-2 btn btn-outline-dark rounded-4"
            type="submit"
          >
            <svg
          ...
          <button
            className="w-100 py-1 mb-2 btn btn-outline-primary rounded-4"
            type="submit"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <button
            className="w-100 py-1 mb-2 btn btn-outline-secondary rounded-4"
            type="submit"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
...
function Navbar() {
  ...
  return (
    <nav className="navbar navbar-expand-lg navbar-dark bg-dark py-3 shadow-sm">
      ...
      >
        <i className="fa fa-sign-in me-1"> Sign up</i>
      </Button>
